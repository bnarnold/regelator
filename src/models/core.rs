...
// Core rule models - Queryable structs (for reading from database)
...
// Core rule models - Insertable structs (for creating new records)
...
// Helper functions for generating UUIDs - Core models
impl NewRuleSet {
